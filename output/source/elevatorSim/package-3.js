  ...
  qx.Class.define("qx.ui.tooltip.Manager", {
    ...
    */
    construct: function construct() {
      ...
      qx.event.Registration.addListener(document.body, "pointerover", this.__onPointerOverRoot__P_73_0, this, true); // Instantiate timers

      this.__showTimer__P_73_1 = new qx.event.Timer();

      this.__showTimer__P_73_1.addListener("interval", this.__onShowInterval__P_73_2, this);

      this.__hideTimer__P_73_3 = new qx.event.Timer();

      this.__hideTimer__P_73_3.addListener("interval", this.__onHideInterval__P_73_4, this); // Init pointer position


      this.__pointerPosition__P_73_5 = {
        left: 0,
        top: 0
      };
    },
    ...
    */
    members: {
      __pointerPosition__P_73_5: null,
      __hideTimer__P_73_3: null,
      __showTimer__P_73_1: null,
      __sharedToolTip__P_73_6: null,
      __sharedErrorToolTip__P_73_7: null,
      ...
      getSharedTooltip: function getSharedTooltip() {
        if (!this.__sharedToolTip__P_73_6) {
          this.__sharedToolTip__P_73_6 = new qx.ui.tooltip.ToolTip().set({
            rich: true
          });
        }

        return this.__sharedToolTip__P_73_6;
      },
      ...
      getSharedErrorTooltip: function getSharedErrorTooltip() {
        if (!this.__sharedErrorToolTip__P_73_7) {
          this.__sharedErrorToolTip__P_73_7 = new qx.ui.tooltip.ToolTip().set({
            appearance: "tooltip-error",
            rich: true
          });

          this.__sharedErrorToolTip__P_73_7.setLabel(""); // trigger label widget creation


          this.__sharedErrorToolTip__P_73_7.syncAppearance();
        }

        return this.__sharedErrorToolTip__P_73_7;
      },
      ...
      */
      ...
      _applyCurrent: function _applyCurrent(value, old) {
        ...
        if (old) {
          ...
          this.__showTimer__P_73_1.stop();

          this.__hideTimer__P_73_3.stop();
        }
        ...
        if (value) {
          this.__showTimer__P_73_1.startWith(value.getShowTimeout()); // Register hide handler


          Registration.addListener(el, "pointerout", this.__onPointerOutRoot__P_73_8, this, true);
          Registration.addListener(el, "focusout", this.__onFocusOutRoot__P_73_9, this, true);
          Registration.addListener(el, "pointermove", this.__onPointerMoveRoot__P_73_10, this, true);
        } else {
          // Deregister hide handler
          Registration.removeListener(el, "pointerout", this.__onPointerOutRoot__P_73_8, this, true);
          Registration.removeListener(el, "focusout", this.__onFocusOutRoot__P_73_9, this, true);
          Registration.removeListener(el, "pointermove", this.__onPointerMoveRoot__P_73_10, this, true);
        }
      },
      ...
      */
       ...
       */
      __onShowInterval__P_73_2: function __onShowInterval__P_73_2(e) {
        var current = this.getCurrent();

        if (current && !current.isDisposed()) {
          this.__hideTimer__P_73_3.startWith(current.getHideTimeout());

          if (current.getPlaceMethod() == "widget") {
            current.placeToWidget(current.getOpener());
          } else {
            current.placeToPoint(this.__pointerPosition__P_73_5);
          }
       ...
       * @param e {qx.event.type.Event} Event object
       */
      __onHideInterval__P_73_4: function __onHideInterval__P_73_4(e) {
        var current = this.getCurrent();
      ...
      */
       ...
       */
      __onPointerMoveRoot__P_73_10: function __onPointerMoveRoot__P_73_10(e) {
        var pos = this.__pointerPosition__P_73_5;
       ...
       */
      __onPointerOverRoot__P_73_0: function __onPointerOverRoot__P_73_0(e) {
        ...
        this.__onPointerMoveRoot__P_73_10(e);
       ...
       */
      __onPointerOutRoot__P_73_8: function __onPointerOutRoot__P_73_8(e) {
      ...
      */
       ...
       */
      __onFocusOutRoot__P_73_9: function __onFocusOutRoot__P_73_9(e) {
        var target = qx.ui.core.Widget.getWidgetByElement(e.getTarget());
    ...
    */
    destruct: function destruct() {
      // Deregister events
      qx.event.Registration.removeListener(document.body, "pointerover", this.__onPointerOverRoot__P_73_0, this, true); // Dispose timers

      this._disposeObjects("__showTimer__P_73_1", "__hideTimer__P_73_3", "__sharedToolTip__P_73_6");

      this.__pointerPosition__P_73_5 = null;
    }
  });
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.style.Stylesheet", {
    ...
    construct: function construct() {
      ...
      this.__sheet__P_74_0 = qx.bom.Stylesheet.createElement();
      this.__rules__P_74_1 = [];
    },
    members: {
      __rules__P_74_1: null,
      __sheet__P_74_0: null,
      ...
      addRule: function addRule(selector, css) {
        ...
        qx.bom.Stylesheet.addRule(this.__sheet__P_74_0, selector, css);

        this.__rules__P_74_1.push(selector);
      },
      ...
      hasRule: function hasRule(selector) {
        return this.__rules__P_74_1.indexOf(selector) != -1;
      },
      ...
      removeRule: function removeRule(selector) {
        delete this.__rules__P_74_1[this.__rules__P_74_1.indexOf(selector)];
        qx.bom.Stylesheet.removeRule(this.__sheet__P_74_0, selector);
      }
    }
  });
  ...
  qx.Class.define("qx.event.handler.UserAction", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__manager__P_80_0 = manager;
      this.__window__P_80_1 = manager.getWindow();
    },
    ...
    */
    members: {
      __manager__P_80_0: null,
      __window__P_80_1: null,
    ...
    */
    destruct: function destruct() {
      this.__manager__P_80_0 = this.__window__P_80_1 = null;
    },
  ...
  qx.Class.define("qx.ui.core.queue.Manager", {
    statics: {
      ...
      scheduleFlush: function scheduleFlush(job) {
        ...
        self.__jobs__P_61_2[job] = true;

        if (!self.__scheduled__P_61_0) {
          self.__canceled__P_61_1 = false;
          qx.bom.AnimationFrame.request(function () {
            if (self.__canceled__P_61_1) {
              self.__canceled__P_61_1 = false;
              return;
            }
      ...
      flush: function flush() {
        ...
        if (self.__inFlush__P_61_4) {
          return;
        }

        self.__inFlush__P_61_4 = true; // Cancel timeout if called manually

        self.__canceled__P_61_1 = true;
        var jobs = self.__jobs__P_61_2;

        self.__executeAndRescheduleOnError__P_61_5(function () {
          // Process jobs
          ...
          self.__scheduled__P_61_0 = false;
        });
        ...
        self.__executeAndRescheduleOnError__P_61_5(function () {
          ...
          // Clear flag
          self.__inFlush__P_61_4 = false;
        }); // flush succeeded successfully. Reset retries


        self.__retries__P_61_3 = 0;
      },
       ...
       */
      __executeAndRescheduleOnError__P_61_5: function __executeAndRescheduleOnError__P_61_5(callback, finallyCode) {
        callback();
        finallyCode();
      },
       ...
       */
      __onUserAction__P_61_6: function __onUserAction__P_61_6(e) {
    ...
    */
    defer: function defer(statics) {
      ...
      qx.event.Registration.addListener(window, "useraction", qx.core.Environment.get("event.touch") ? statics.__onUserAction__P_61_6 : statics.flush);
    }
  });
  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.Css", {
    statics: {
        ...
        if (elem) {
          if (qx.dom.Node.isElement(elem)) {
            ...
            if (force) {
              ...
              elementHeight = qx.module.Css.__swap__P_156_0(elem, stylesToSwap, "_getHeight", this);
            } else {
        ...
        if (elem) {
          if (qx.dom.Node.isElement(elem)) {
            ...
            if (force) {
              ...
              elementWidth = qx.module.Css.__swap__P_156_0(elem, stylesToSwap, "_getWidth", this);
            } else {
      ...
      _getContentHeight: function _getContentHeight(force) {
        ...
        if (qx.dom.Node.isElement(obj)) {
          ...
          if (force) {
            ...
            contentHeight = qx.module.Css.__swap__P_156_0(obj, stylesToSwap, "_getContentHeight", this);
          } else {
      ...
      _getContentWidth: function _getContentWidth(force) {
        ...
        if (qx.dom.Node.isElement(obj)) {
          ...
          if (force) {
            ...
            contentWidth = qx.module.Css.__swap__P_156_0(obj, stylesToSwap, "_getContentWidth", this);
          } else {
       ...
       * or <code>block</code>
       */
      __getDisplayDefault__P_156_2: function __getDisplayDefault__P_156_2(tagName, doc) {
        var defaults = qx.module.Css.__displayDefaults__P_156_1;
       ...
       */
      __swap__P_156_0: function __swap__P_156_0(element, styles, methodName, context) {
        ...
        this._forEachElementWrapped(function (item) {
          ...
          if (currentVal == "none") {
            if (prevVal && prevVal != "none") {
              ...
              newVal = qx.module.Css.__getDisplayDefault__P_156_2(item[0].tagName, doc);
            }
...
//# sourceMappingURL=package-3.js.map?dt=1636141339420
qx.$$packageData['3'] = {
  "locales": {},
  "resources": {},
  "translations": {}
